...
import cifar_processing as cifar
...
def load_cifar():
    ...
    x_train = cifar.create_cifar_array()[0]
    y_train = cifar.create_cifar_array()[1] 
    x_test = cifar.create_cifar_array()[2]
    y_test = cifar.create_cifar_array()[3]
